function buildMcpAgentGuide(endpoint) {
    ...
    return [
      ...
      '## Runtime Discovery',
      '',
      'Runtime information is discovered through MCP tools.',
      '',
      'The local shared directory, current working directory, Skill Folder, available skill count, permission state, MCP version, transport protocol, available tools, root boundary mode, file write/delete permission, and command execution permission should be read from MCP responses such as `tunnel_status`, `tools/list`, and `skill list`.',
      '',
      '## Tool Discovery',
      '',
      ...
      '',
      'After connection, the current runtime status, tool list, shared directory, Skill Folder, skill count, and permission state are determined by MCP responses.',
      '',
    ].join('\n');
  }
