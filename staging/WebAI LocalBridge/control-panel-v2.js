  ...
  <div class="collapsible" id="user-guide">
    ...
    <div class="collapsible-body">
      ...
      <div class="guide-step">
        ...
        <div class="lang-zh">
          <p>固定域名模式需要先在 Cloudflare Tunnel 中配置 Public Hostname。只需要一个基础域名，例如 svjlyvq.ccwu.cc，然后分别添加 mcp、files、files2 子域名：mcp.svjlyvq.ccwu.cc 转发到 127.0.0.1:33003，files.svjlyvq.ccwu.cc 转发到 127.0.0.1:33005，files2.svjlyvq.ccwu.cc 转发到 127.0.0.1:33006。不要配置 33004 控制台。</p>
