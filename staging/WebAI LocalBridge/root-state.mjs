 ...
 * @param {string} baseDomain - e.g. "svjlyvq.ccwu.cc"
 ...
 * Accepts: svjlyvq.ccwu.cc, example.com, my-domain.pp.ua
 * Rejects: https://svjlyvq.ccwu.cc, http://example.com, mcp.example.com, example.com/path, localhost, 127.0.0.1, [::1]
 */
